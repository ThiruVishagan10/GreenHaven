...
import Link from "next/link";
import { useRouter, usePathname } from "next/navigation";
import { User, LogOut, ShoppingBag, UserCircle, Heart } from "lucide-react";
import { UserAuth } from "@/lib/context/AuthContent";
import { useAdminAuth } from "@/lib/context/AdminAuth";
import { useFavorites } from "@/lib/context/FavoritesContext"; // Add this import
...
const NavBar = () => {
  ...
  const { getFavoriteCount } = useFavorites(); // Add this
      ...
      <div className="flex items-center gap-4 relative">
        ...
        {user ? (
          ...
          <>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md overflow-hidden top-full">
                <ul className="text-gray-700">
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer flex items-center gap-2">
                    <User size={18} />
                    <Link href="/profile">Profile</Link>
